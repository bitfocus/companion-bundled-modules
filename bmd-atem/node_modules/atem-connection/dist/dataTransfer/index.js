...
class DataTransferManager {
    constructor(rawSendCommands) {
        ...
        _DataTransferManager_sendLockCommand.set(this, (/*lock: DataTransferLockingQueue,*/ cmd) => {
            Promise.all(tslib_1.__classPrivateFieldGet(this, _DataTransferManager_rawSendCommands, "f").call(this, [cmd])).catch((e) => {
            ...
            this.interval = setInterval(() => {
                for (const lock of this.allLocks) {
                    ...
                    if (commandsToSend && commandsToSend.length > 0) {
                        ...
                        Promise.all(tslib_1.__classPrivateFieldGet(this, _DataTransferManager_rawSendCommands, "f").call(this, commandsToSend)).catch((e) => {
