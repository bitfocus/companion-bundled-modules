...
class DataTransferUploadClipFrame extends dataTransferUploadBuffer_1.DataTransferUploadBuffer {
    constructor(clipIndex, frameIndex, buffer) {
        ...
        (0, tslib_1.__classPrivateFieldSet)(this, _DataTransferUploadClipFrame_dataLength, buffer.rawDataLength, "f");
    }
    async startTransfer(transferId) {
        debug(`Start transfer ${transferId} (${(0, tslib_1.__classPrivateFieldGet)(this, _DataTransferUploadClipFrame_dataLength, "f")})`);
        const command = new DataTransfer_1.DataTransferUploadRequestCommand({
            ...
            size: (0, tslib_1.__classPrivateFieldGet)(this, _DataTransferUploadClipFrame_dataLength, "f"),
            mode: 1,
        });
        return {
            newState: dataTransfer_1.DataTransferState.Ready,
