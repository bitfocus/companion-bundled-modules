camstreamer camstreamer Cameras

## This module supports the following camstreamer camstreamer cameras.
...
For additional actions, please raise a feature request on [GitHub](https://github.com/bitfocus/companion-module-camstreamer-camstreamer/).
